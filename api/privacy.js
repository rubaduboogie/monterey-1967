...
<p>Для оценки работы сайта отдельно учитываются технические сведения: источник перехода, рекламная кампания, тип устройства, адрес открытой страницы, действия на странице и время посещения. Для этого используется сервис «Яндекс.Метрика», включая Вебвизор, карты кликов и отслеживание ссылок. Сервис может использовать файлы cookie и обрабатывать технические данные в соответствии с условиями Яндекса. Собственный счётчик сайта не запрашивает имя, контакты или точное местоположение и не сохраняет IP-адрес в сообщении статистики.</p>
...
<p>В необходимом объёме данные могут обрабатываться платёжным провайдером ЮKassa, сервисом веб-аналитики «Яндекс.Метрика» и техническими подрядчиками, обеспечивающими работу сайта и служебные уведомления. Передача не используется для продажи данных, рекламных рассылок третьих лиц или формирования сторонних баз клиентов.</p>
